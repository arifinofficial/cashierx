<form action="{{ route('product.main-product.product.store', [$mainProduct->id]) }}" method="POST"
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="products[{{ $key }}][price]" id="price" value="{{ old('price') }}"
                ...
                <div class="col-md-6 pt-3 pt-md-0">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="products[{{ $key }}][grab_price]" id="grab_price" value="{{ old('grab_price') }}"
                            class="{{ $errors->has('grab_price') ? 'form-control is-invalid' : 'form-control' }}">
            ...
            <div class="form-group mt-3 mt-md-3">
                ...
                <input type="file" name="products[{{ $key }}][picture]" id="picture" class="form-control-file"
                    id="exampleFormControlFile1">
            </div>
            <div class="form-group mt-3 mt-md-3">
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" name="products[{{ $key }}][is_active]" value="0"
                        id="exampleCheck1">
